...
class CajasDespachosScreen extends StatefulWidget {
  @override
  _CajasDespachosScreenState createState() => _CajasDespachosScreenState();
...
class _CajasDespachosScreenState extends State<CajasDespachosScreen> {
  ...
  _getData() async {
    try {
      ...
      final response = await HttpHandler()
          .jsonDespachos("api/CantidadCajasDespachoMovil", dtoDespacho);
            ...
            if (snapshot.data != null)
              return new Container(
                  ...
                  child: charts.BarChart(
                    CajasDespachosScreen.cargarDatosGrafico(snapshot.data),
                    vertical: true,
                    animate: true,
                    behaviors: [
